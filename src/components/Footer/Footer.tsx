  ...
  return (
    <div className='container row m-auto' style={{paddingBottom:'100px'}}>
        ...
        <div className='col-md-3 col-sm-6'>
          <h3 style={{color:'#00431a'}}>Catagoles</h3>
          <p>Graphics & Design</p>
        ...
        <div className='col-md-3 col-sm-6'>
        <h3 style={{color:'#00431a'}}>About</h3>
          <p>Careers</p>
          <p>Press & News</p>
          <p>Partnerships</p>
          <p>Pravicy Policy</p>
        ...
        <div className='col-md-3 col-sm-6'>
        <h3 style={{color:'#00431a'}}>Community</h3>
          <p>Events</p>
          <p>Blog</p>
          <p>Forum</p>
        ...
        <div className='col-md-3 col-sm-6'>
        <h3 style={{color:'#00431a'}}>More From Fiverr</h3>
          <p>Fiverr Pro</p>
          <p>Fiverr Studio</p>
        ...
        <hr />
        <div className='row '>
      <div className='col-md-4 col-sm-12 align-items-center d-flex'>
      <img src={process.env.PUBLIC_URL + '/assets/img/logo-footer.png'} alt='...' style={{ width: '100px' }}></img>
      <span className='mx-3'><i className="fa fa-copyright" style={{color:'#1dbf73'}}></i> Fiverr InterNational Ltd.2021</span>
      </div>
      ...
      <div className='col-md-4 col-sm-12 text-center' >
      <i className="fa fa-globe-americas mx-2" style={{color:'#1dbf73'}}></i>
      <span className='mx-2'>English</span>
      <span className='mx-2'>$USD</span>
      <i className="fa fa-people-carry mx-2"style={{color:'#1dbf73'}}></i>
      </div>
        </div>
    </div>
  )
